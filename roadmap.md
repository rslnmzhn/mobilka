...
- [ ] 4. Мягкий лимит размера memory.md при instant-записи (защита от переполнения).
...
- [ ] 14. Новый системный промпт дефолтного агента под полную схему.

## Milestone M5 — Shell polish
- [ ] 15. Нижняя панель и десктопный рельс: только иконки, тултипы на десктопе.
- [ ] 16. Регресс-тесты шела на 320px без подписей.
